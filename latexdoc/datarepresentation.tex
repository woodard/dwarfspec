...
\bb
see Section \refersec{chap:attributeencodingsimplicitconst}),
...
followed by a byte sequence of the specified length (\DWFORMexprlocTARG)
...
may be used to access a location 
\bb
list.
\eb
\db
