...
the attribute value itself is in the \dotdebuginfo{}
section which begins with an unsigned LEB128 number that 
specifies the form followed by the value according that form. 
\eb
...
\bb
For attributes with the form \DWFORMaddrxoffset{}, the attribute  
...
\DWFORMaddrxoffset{} is then computed by adding those two values together 
...
\bb
are described in Section \refersec{chap:stringoffsetstable}.
\eb
\end{itemize}
