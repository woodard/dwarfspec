...
\db	% and \dotdebugaranges
section may contain references to locations within the virtual address
...
\item The \HFNdebuginfooffset{} field in the
\bb
headers of the compilation units listed
\eb
following the \dotdebugnames{} header contain
...
\bb
\dotdebugframe{} and \dotdebugnames{},
\eb
\db	% and \dotdebugaranges,
respectively.
\needlines{4}
...
\db	%\dotdebugaranges{} & \HFNdebuginfooffset{} & offset in \dotdebuginfo{} \\
...
\db	% Delete Section 7.21, Address Range Table
