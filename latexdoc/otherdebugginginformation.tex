...
a cooperating consumer via an augmentation 
\bb
block, 
\eb
described below.}
...
The size in bytes of the augmentation block. 
...
\addtoindexx{augmentation block}
A vendor-specific 
\bb
sequence of bytes, 
\eb
...
The augmentation 
\db
only provides hints to the consumer regarding
...
(see Section \refersec{linenumberprograminstructions}).
\eb
