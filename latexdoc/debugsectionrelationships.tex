...
\node(zlinkd)   at (5, 12.1)  [link] {\DWFORMstrp\textit{[8]}~~(d)};
...
% The fourth column
%
\node(zlinky)   at (15.6, 12.0) [link] {\begin{tabular}{c}
                                        \DWMACROdefinestrp \\
                                        \DWMACROundefstrp \\
                                        (p)
                                        \end{tabular}};
\node(zlinkz)   at (15.6,  7.9) [link] {\begin{tabular}{c}
                                        \DWMACROimport \\
                                        (q)
                                        \end{tabular}};
\node(zcircsp)  at (17.4,  6.3) [circ]  {\textit{A}};
\node(zlinkx)   at (15.6,  5.0) [link]  {\DWFORMlinestrp~(r, s)};
\node(zsectlns) at (15.6,  3.5) [sect]  {\dotdebuglinestr};
\node(zlinkw)   at (15.6,  1.5) [link] {\begin{tabular}{c}
                                        \DWRLEbaseaddressx \\
										\DWRLEstartxendx~~~(t) \\
										\DWRLEstartxlength
										\end{tabular}};
