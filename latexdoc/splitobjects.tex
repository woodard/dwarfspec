...
specification, and vary with each
\bb
producer's
\eb
implementation.
...
section. This contains the
\bb
value lists and
\eb
location lists normally found in
...
\hline
\DWATloclistsbase       & \chkmk  &        &           & \bbeb\chkmk&         \\
\hline
...
\hline
\DWATrnglistsbase       & \chkmk  &        &\bbeb\chkmk& \bbeb\chkmk&         \\
\hline
\DWATstmtlist           & \chkmk  & \chkmk &  \chkmk   &        	& \chkmk  \\
\hline
\bbeb
\DWATstroffsets   		& \chkmk  & \chkmk &  \chkmk   & \bbeb\chkmk&         \\
\hline
...
address lookup, the consumer can use the 
\bb
unit level \DWATlowpc/\DWAThighpc{} and/or \DWATranges{} attributes
to identify
\eb  
a skeleton compilation unit. For a file
...
\bb
The unit level \DWATlowpc/\DWAThighpc{} and/or \DWATranges{} attributes
\eb  
allow a DWARF consumer to map a PC value to
...
The \dotdebugloclistsdwo{} section contains the
\bb
value lists and
\eb
