...
\texttt{\url{http://dwarfstd.org/LanguagesV6.php}}. 
\eb
...
\endlastfoot
\bb
\DWLNAMEAdaTARG~\dag 		& ISO \Ada 		& \LVESYYYY \\
...
\DWLNAMECPPforOpenCLTARG~\dag& \CPPforOpenCL& \LVESVVMM \\
\DWLNAMECrystalTARG 		& \Crystal 		& \\
\DWLNAMECsharpTARG 			& \Csharp 		& \\
\DWLNAMEDTARG{}~\dag 		& \D 			& \\
\DWLNAMEDylanTARG~\dag 		& \Dylan 		& \\
\DWLNAMEFortranTARG 		& ISO \Fortran 	& \LVESYYYY \\
\DWLNAMEGoTARG{}~\dag 		& \Go 			& \\
\DWLNAMEGLSLTARG{}~\dag 	& \GLSL			& \LVESVVMMPP \\
\DWLNAMEGLSLESTARG{}~\dag 	& \GLSLES		& \LVESVVMMPP \\
\DWLNAMEHaskellTARG{}~\dag 	& \Haskell 		& \\
\DWLNAMEHLSLTARG{}~\dag 	& \HLSL 		& \LVESYYYY \\
\DWLNAMEJavaTARG{} 			& \Java 		& \\
\DWLNAMEJuliaTARG{}~\dag 	& \Julia 		& \\
...
\DWLNAMEOCamlTARG{}~\dag  	& \OCaml 		& \\
\DWLNAMEOpenCLCTARG\footnote{This is equivalent to DW\_LANG\_OpenCL in \DWARFVersionV}~\dag
							& \OpenCLC 		& \LVESVVMM \\
\DWLNAMEOpenCLCPPTARG~\dag	& \OpenCLCPP	& \LVESVVMM \\	
\DWLNAMEPascalTARG 			& ISO \Pascal	& \LVESYYYY \\
\DWLNAMEPLITARG{}~\dag 		& ANSI \PLI 	& \\
\DWLNAMEPythonTARG{}~\dag 	& \Python 		& \\
\DWLNAMERenderScriptTARG~\dag & \RenderScript{} Kernel Language & \\
\bbeb
\DWLNAMERubyTARG{}~\dag 	& \Ruby 		& \LVESVVMM \\
\DWLNAMERustTARG{}~\dag 	& \Rust 		& \\
\DWLNAMESwiftTARG{} 		& \Swift 		& \\*
\DWLNAMESYCLTARG~\dag		& \SYCL			& \LVESYYYYRR \\
\DWLNAMEUPCTARG{} 			& \UPC~(Unified Parallel C) &   
								\index{Unified Parallel C|see{UPC}} \\*
\eb\bbeb
\DWLNAMEZigTARG 			& \Zig 			& \\*
\hline
\multicolumn{3}{l}{\dag \ \ \textit{Support for these languages is limited}} \\
\end{longtable}
\end{centering}
...
\LVESYYYYMM & Year in which the language definition was released times 100
