...
David Anderson,\dag~Associate Editor \\
\bbeb
David Blaikie~\dag		& Google \\
Ron Brender,\dag~Editor\\
Andrew Cagney\\
Eric Christopher        & Google \\
\bbeb
Cary Coutant,\dag~Chair (from March 2023) \\
\bbeb
...
Zoran Zaric				& AMD \\
\bbeb
\dag~Member, Executive Committee \\
\end{tabular}
\end{center}
